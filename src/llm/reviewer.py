...
class Reviewer:
    ...
    def __init__(self, config: Dict[str, Any], device: str = 'cuda'):
        ...
        # Model paths
        self.base_model_name = reviewer_config.get('base_model', 'meta-llama/Llama-2-7b-chat-hf')
        self.fine_tuned_model_path = reviewer_config.get('fine_tuned_model', 'models/reviewer_finetuned')
    ...
    def review_actions(self, state_info: Dict[str, Any], 
    ...
    def _format_review_prompt(self, state_info: Dict[str, Any], 
