...
\input{capitoli/capitolo6_conclusioni} % This line was missing a closing brace

% Ensure all itemize environments are properly closed in the included chapters.
% If the error persists, check each capitolo*.tex file for unclosed \begin{itemize}.
