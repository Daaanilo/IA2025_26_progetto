...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{immagini/heron/multi_metric_dashboard.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/multi_metric_dashboard.png}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/collect_wood.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_collect_wood.png}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/collect_sapling.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_collect_sapling.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/place_table.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_place_table.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/place_plant.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_place_plant.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/defeat_zombie.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_defeat_zombie.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/collect_drink.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_collect_drink.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/eat_cow.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_eat_cow.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/heron/achievement_curves/wake_up.png}
    \caption*{HeRoN}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{immagini/plots_dqn_BASE/achievement_curves/learning_curve_wake_up.png}
    \caption*{DQN Baseline}
\end{minipage}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{immagini/heron/reward_distribution.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{immagini/plots_dqn_BASE/reward_distribution.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{immagini/heron/moving_averages.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{immagini/plots_dqn_BASE/moving_averages.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{immagini/heron/efficiency_scatter.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{immagini/plots_dqn_BASE/efficiency_scatter.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{immagini/heron/helper_dependency.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{immagini/plots_dqn_BASE/helper_dependency.png}
...
\centering
\begin{verbatim}
collect_sapling: ████████████████████████ (ep 0-300, distribuzione uniforme)
wake_up:         ██████████████████       (ep 0-280, concentrati in ep 0-150)
place_plant:     ████████████████         (ep 8-290, picco in ep 50-150)
collect_wood:    ██████████               (ep 1-275, variabile)
collect_drink:   ████████                 (ep 2-260, sporadico)
\end{verbatim}
\caption{Timeline unlock achievement (ogni █ = 10 unlock)}
...
\begin{enumerate}
    \item \textbf{Immediate DQN Fallback} (health ≤ 5):
    \begin{itemize}
