...
\subsection{Fase 1: Setup dell'Environment}
...
\subsubsection{Wrapper dell'Environment}
...
\subsubsection{Testing Iniziale}
...
\subsection{Fase 2: Sviluppo del NPC (DQN Agent)}
...
\centering
\small
\begin{tabular}{@{}p{1.5cm}p{5cm}p{3cm}p{2cm}@{}}
\toprule
...
\midrule
V3.0 & + Warning typo comuni (place\_rock→place\_stone) & Errori ricorrenti & 78\% valid \\
\midrule
...
\midrule
\textbf{V7.0} & \textbf{+ Placeholder prevention, token overflow management} & \textbf{Placeholder usage, verbose output} & \textbf{98\% valid} \\ \bottomrule
\end{tabular}
