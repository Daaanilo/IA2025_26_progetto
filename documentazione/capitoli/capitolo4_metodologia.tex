...
\begin{itemize}
    ...
    \item \textbf{Hidden Layer 1}: 256 neuroni, attivazione ReLU, Dropout(0.1)
    \item \textbf{Hidden Layer 2}: 256 neuroni, attivazione ReLU, Dropout(0.1)
    \item \textbf{Hidden Layer 3}: 128 neuroni, attivazione ReLU
