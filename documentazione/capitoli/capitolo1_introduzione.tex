...
\begin{itemize}
    ...
    \item \textbf{Generazione di sequenze}: Modificare l'Helper per generare sequenze di 3-5 azioni coerenti anziché singole decisioni, enabling strategic planning
