...
\section{Efficacia dei Componenti}
...
\subsection{Challenge 2: Qualità del Dataset per Reviewer}
...
\begin{enumerate}
    ...
    \item \textbf{Memoria GPU}: Mantenere DQN + LLM in memoria richiede GPU con $\geq$8GB VRAM
\end{enumerate}
