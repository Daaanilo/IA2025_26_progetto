...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='models/baseline',
...
def main():
    ...
    for episode in range(num_episodes):
        ...
        if (episode + 1) % 10 == 0:
            recent_rewards = [l['reward'] for l in training_log[-10:]]
        ...
        if (episode + 1) % args.save_freq == 0:
            checkpoint_path = os.path.join(args.save_dir, f'npc_baseline_ep{episode+1}.pth')
